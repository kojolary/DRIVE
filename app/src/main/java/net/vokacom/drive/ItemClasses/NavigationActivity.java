...
public class NavigationActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, ProductAdapter.OnItemClickListener {
    ...
    private final String URL = "https://app.tedxafariwaa.com/LoginandRegistration/products.php";
...
// Creating Progress dialog.
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    adapter.setOnItemClickListener(NavigationActivity.this);

                } catch (JSONException e) {
                    e.printStackTrace();
                    Toast.makeText(NavigationActivity.this, "Unable to get data, check internet", Toast.LENGTH_SHORT).show();
    ...
    public void OnItemClick(int position) {
        ...
        Intent myIntents = new Intent(NavigationActivity.this, DetailedForPurchase.class);


        myIntents.putExtra("EXTRA_ID", String.valueOf(clickedItem.getId()));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent a = new Intent(NavigationActivity.this, WomenActivity.class);
            startActivity(a);
        } else if (id == R.id.nav_gallery) {

            Intent a = new Intent(NavigationActivity.this, MenActivity.class);
            startActivity(a);
