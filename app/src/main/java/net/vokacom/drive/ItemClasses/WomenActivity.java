...
import net.vokacom.drive.mListView.ProductAdapterWomen;
...
public class WomenActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, ProductAdapterWomen.OnItemClickListener {
    ...
    private String URL = "https://app.tedxafariwaa.com/LoginandRegistration/products.php";
...
// Creating Progress dialog.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productListWomen = new ArrayList<>();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        productListWomen.add(new ProductWomen(
                                product.getInt("id"),
                    ...
                    ProductAdapterWomen adapter = new ProductAdapterWomen(getApplication(), productListWomen);
                    rV.setAdapter(adapter);
                    adapter.setOnItemClickListener(WomenActivity.this);

                } catch (JSONException e) {
                    e.printStackTrace();
                    Toast.makeText(WomenActivity.this, "Unable to get data, check internet", Toast.LENGTH_SHORT).show();
...
//           Intent a = new Intent(WomenActivity.this, WomenActivity.class);
//            startActivity(a);
        } else if (id == R.id.nav_gallery) {
            Intent a = new Intent(WomenActivity.this, MenActivity.class);
            startActivity(a);
    ...
    public void OnItemClick(int position) {
        ProductWomen clickedItem = productListWomen.get(position);
        Intent myIntents;
        ...
        myIntents.putExtra("TYPE_OF_ACCOUNT", "WOMEN");
